...
ติดตั้ง Yarn สำหรับติดตั้ง Strapi โดยใช้คำสั่ง
```
npm install -g yarn
```
หลังจากดาวน์โหลดสามารถตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package Yarn ถูกติดตั้งไว้แล้วโดยใช้คำสั่ง
```
yarn -v #ตรวจสอบเวอร์ชั่น Yarn
```

หลังจากติดตั้ง Yarn แล้วเราจะสร้าง Strapi project โดยใช้คำสั่ง
...
หลังจากดาวน์โหลดสามารถตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package Git ถูกติดตั้งไว้แล้วโดยใช้คำสั่ง
```
