...
npm install -g yarn
```
หลังจากดาวน์โหลดสามารถตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package Yarn ถูกติดตั้งไว้แล้ว
```
...
หลังจากดาวน์โหลดสามารถตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package Git ถูกติดตั้งไว้แล้ว
```
...
หลังจากเชื่อมต่อ instance กับเครื่องได้แล้วจำเป็นต้องอัพเดท apt และติดตั้ง package ที่จำเป็น
```
...
สร้าง directory สำหรับรัน project
```
