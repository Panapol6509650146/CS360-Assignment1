...
## ขั้นตอนในการติดตั้ง Strapi ทั้งหมด
### ติดตั้ง Strapi
...
1.สร้าง repository ได้ที่ https://github.com/ และตั้งชื่อ repository ตามต้องการเช่น ..my-repo..

2.ดาวน์โหลด Git Bash ได้ที่ https://git-scm.com/download/win
...
3.ตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package Git ถูกติดตั้งไว้แล้วใน Git Bash
```
git -v #ตรวจสอบเวอร์ชั่น Git
```
4.ในการ push code ขึ้น GitHub มีขั้นตอนการรันคำสั่งดังนี้
```
#setup เบื้องต้น
cd ..ชื่อ project.. #ถ้ายังไม่อยู่ใน directory project
...
## ขั้นตอนการ Deploy
1.launch instance โดยขั้นตอนการ launch instance มีดังนี้ :<sub>*ขั้นตอนนี้จะได้ Key.pem มา<sub>
...
2.เชื่อมต่อ instace นี้กับเครื่องของเราโดยทำตามขั้นตอนดั้งนี้
...
3.อัพเดท apt และติดตั้ง package ที่จำเป็น
```
...
```
ตรวจสอบเวอร์ชั่นเพื่อให้มั่นใจว่า package ถูกติดตั้งไว้แล้ว
```
npm -v #ตรวจสอบเวอร์ชั่น Node Package Manager
node -v #ตรวจสอบเวอร์ชั่น Node.js
yarn -v #ตรวจสอบเวอร์ชั่น Yarn
...
6.setup .env ของเว็บไซต์ โดย copy template จาก .env.example
```
...
```
8.สร้างไฟล์สำหรับรัน project
```
cd .. #อกกมา directory ข้างนอก
